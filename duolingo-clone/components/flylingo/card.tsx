...
/**
 * The clone's lesson card, with the Drizzle `challenges.type` union replaced by a
 * local `CardType` so this route needs no database import. Layout and classes are
 * otherwise unchanged from sanidhyy/duolingo-clone.
 */
type CardProps = {
  id: number;
  text: string;
